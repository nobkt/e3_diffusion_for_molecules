...
ase_db_with_h = {
    'name': 'ase_db',
    'atom_encoder': {'H': 0, 'C': 1, 'N': 2, 'O': 3, 'F': 4, 'Si': 5, 'P': 6, 'S': 7, 'Cl': 8, 'Br': 9, 'I': 10},  # All 11 element types found in ASE databases
    'atom_decoder': ['H', 'C', 'N', 'O', 'F', 'Si', 'P', 'S', 'Cl', 'Br', 'I'],  # Updated to include all 11 element types
    ...
    'colors_dic': ['#FFFFFF99', 'C7', 'C0', 'C3', 'C1', 'C2', 'C4', 'C5', 'C6', 'C8', 'C9'],  # Added one more color for Si
    'radius_dic': [0.46, 0.77, 0.77, 0.77, 0.77, 0.77, 0.77, 0.77, 0.77, 0.77, 0.77],  # Added one more radius for Si
    'with_h': True
}

ase_db_without_h = {
    'name': 'ase_db',
    'atom_encoder': {'C': 0, 'N': 1, 'O': 2, 'F': 3, 'Si': 4, 'P': 5, 'S': 6, 'Cl': 7, 'Br': 8, 'I': 9},  # All non-H element types found in ASE databases
    'atom_decoder': ['C', 'N', 'O', 'F', 'Si', 'P', 'S', 'Cl', 'Br', 'I'],  # Updated to include all 10 non-H element types
    'max_n_nodes': 100,  # Default, will be updated based on actual data
    'n_nodes': {},  # Will be populated based on actual data
    'atom_types': {},  # Will be populated based on actual data
    'distances': [],  # Will be populated based on actual data if needed
    'colors_dic': ['C7', 'C0', 'C3', 'C1', 'C2', 'C4', 'C5', 'C6', 'C8', 'C9'],  # Added one more color for Si
    'radius_dic': [0.77, 0.77, 0.77, 0.77, 0.77, 0.77, 0.77, 0.77, 0.77, 0.77],  # Added one more radius for Si
    'with_h': False
}
